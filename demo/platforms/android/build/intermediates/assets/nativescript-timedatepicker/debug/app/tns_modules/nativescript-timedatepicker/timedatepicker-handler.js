...
function setMinDate(date) {
    if (_isInitFunction()) {
        // console.log("We call the min "+date );
        // console.log("the transformation is "+_toNativeDate(date));
        // console.log("this is the picker "+_getDatePickerDialog());
        // console.log("this is the picker and setmin "+_getDatePickerDialog().setMinDate);
        

        _getDatePickerDialog().setMinDate(_toNativeDate(date));
        console.log("the min is "+ _getDatePickerDialog().getMinDate());
    }
}
